...
## API проекта
Полная API спецификация проекта доступна по эндпоинту [/api/docs/](/api/docs/) в формате Redoc.
...
POSTGRES_DB=foodgram                     # Название базы данных PostgreSQL
POSTGRES_USER=foodgram_user              # Имя пользователя базы данных PostgreSQL
POSTGRES_PASSWORD=foodgram_password      # Пароль к базе данных PostgreSQL
DB_NAME=foodgram                         # Название базы данных
DB_HOST=db                               # Имя хоста
DB_PORT=5432                             # Порт для соединения с базой данных
SECRET_KEY=ХХХ                           # Уникальный секретный ключ Django
